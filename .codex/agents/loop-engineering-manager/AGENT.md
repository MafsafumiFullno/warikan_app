...
- Engineering Function の責務分配が必要な場合は `docs/ai-driven/engineering-responsibilities.md` と `.codex/agents/engineering-manager/AGENT.md` を読む
- ドメイン判断がある場合は `docs/domain/warikan/common-invariants.md` を読む

## 管理対象 Skill

- 設計整理: `.codex/skills/spec-architect/SKILL.md`
- Engineering Manager: `.codex/agents/engineering-manager/AGENT.md`
