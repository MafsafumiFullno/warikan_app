...
| Phase | Skill | パス |
|-------|-------|------|
| 1 設計 | spec-architect | `.codex/skills/spec-architect/SKILL.md` |
| 2 実装 | tdd-implementer | `.codex/skills/tdd-implementer/SKILL.md` |
| 3 契約 | api-contract-keeper | `.codex/skills/api-contract-keeper/SKILL.md` |
| 4 判定 | qa-spec-guard | `.codex/skills/qa-spec-guard/SKILL.md` |
